(self["webpackChunkmemory"] = self["webpackChunkmemory"] || []).push([["node_modules_ionic_core_dist_esm_ion-action-sheet_entry_js"],{
...
/* harmony import */ var _hardware_back_button_7b6ede21_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./hardware-back-button-7b6ede21.js */ 65965);
/* harmony import */ var _overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-d577c227.js */ 74202);
/* harmony import */ var _haptic_7b8ba70a_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./haptic-7b8ba70a.js */ 96663);
/* harmony import */ var _button_active_5da929d4_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./button-active-5da929d4.js */ 45581);
/* harmony import */ var _theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./theme-5641d27f.js */ 76996);
...
const ActionSheet = class {
    constructor(hostRef) {
        ...
        this.didPresent = (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetDidPresent", 7);
        this.willPresent = (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetWillPresent", 7);
        this.willDismiss = (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetWillDismiss", 7);
        this.didDismiss = (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetDidDismiss", 7);
        ...
        this.dispatchCancelHandler = (ev) => {
            ...
            if ((0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.i)(role)) {
     ...
     */
    present() {
        return (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
    }
    connectedCallback() {
        (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.e)(this.el);
    }
    /**
     ...
     */
    dismiss(data, role) {
        return (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the action sheet did dismiss.
     */
    onDidDismiss() {
        return (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionActionSheetDidDismiss');
    }
    /**
     ...
     */
    onWillDismiss() {
        return (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionActionSheetWillDismiss');
    }
    ...
    async callButtonHandler(button) {
        if (button) {
            ...
            const rtn = await (0,_overlays_d577c227_js__WEBPACK_IMPORTED_MODULE_7__.s)(button.handler);
            if (rtn === false) {
    ...
    componentDidLoad() {
        ...
        if (this.gesture || (0,_ionic_global_23e7365a_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'md' || !wrapperEl || !groupEl) {
            return;
        }
        (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.f)(() => {
            const isScrollable = groupEl.scrollHeight > groupEl.clientHeight;
            if (!isScrollable) {
                this.gesture = (0,_button_active_5da929d4_js__WEBPACK_IMPORTED_MODULE_9__.c)(wrapperEl, (refEl) => refEl.classList.contains('action-sheet-button'));
    ...
    render() {
        ...
        return ((0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "dialog", "aria-modal": "true", tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({ [mode]: true }, (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_10__.g)(this.cssClass)), { 'action-sheet-translucent': this.translucent }), onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { tappable: this.backdropDismiss }), (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" }), (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-wrapper ion-overlay-wrapper", role: "dialog", ref: el => this.wrapperEl = el }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-container" }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-group", ref: el => this.groupEl = el }, this.header !== undefined &&
            (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-title" }, this.header, this.subHeader && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-sub-title" }, this.subHeader)), buttons.map(b => (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: buttonClass(b), onClick: () => this.buttonClick(b) }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "action-sheet-button-inner" }, b.icon && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: b.icon, lazy: false, class: "action-sheet-icon" }), b.text), mode === 'md' && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null)))), cancelButton &&
            (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-group action-sheet-group-cancel" }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: buttonClass(cancelButton), onClick: () => this.buttonClick(cancelButton) }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "action-sheet-button-inner" }, cancelButton.icon &&
                (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: cancelButton.icon, lazy: false, class: "action-sheet-icon" }), cancelButton.text), mode === 'md' && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null))))), (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" })));
    }
    get el() { return (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
const buttonClass = (button) => {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, 'ion-focusable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_10__.g)(button.cssClass));
};
ActionSheet.style = {
