(self["webpackChunkmemory"] = self["webpackChunkmemory"] || []).push([["node_modules_ionic_core_dist_esm_ion-back-button_entry_js"],{
...
const BackButton = class {
    constructor(hostRef) {
        ...
        this.onClick = async (ev) => {
            ...
            return (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_2__.o)(this.defaultHref, ev, 'back', this.routerAnimation);
        };
    }
    componentWillLoad() {
    ...
    get backButtonText() {
        const defaultBackButtonText = (0,_ionic_global_23e7365a_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios' ? 'Back' : null;
    ...
    render() {
        ...
        return ((0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
                [mode]: true,
                'button': true,
                'back-button-disabled': disabled,
                'back-button-has-icon-only': hasIconOnly,
                'in-toolbar': (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_2__.h)('ion-toolbar', this.el),
                'in-toolbar-color': (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_2__.h)('ion-toolbar[color]', this.el),
                'ion-activatable': true,
                'ion-focusable': true,
                'show-back-button': showBackButton
            }) }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: type, disabled: disabled, class: "button-native", part: "native", "aria-label": backButtonText || 'back' }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "button-inner" }, backButtonIcon && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { part: "icon", icon: backButtonIcon, "aria-hidden": "true", lazy: false }), backButtonText && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { part: "text", "aria-hidden": "true", class: "button-text" }, backButtonText)), mode === 'md' && (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", { type: this.rippleType }))));
    }
