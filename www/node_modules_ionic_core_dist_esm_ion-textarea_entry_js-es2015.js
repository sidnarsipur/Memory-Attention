(self["webpackChunkmemory"] = self["webpackChunkmemory"] || []).push([["node_modules_ionic_core_dist_esm_ion-textarea_entry_js"],{
...
const Textarea = class {
    ...
    componentDidLoad() {
        (0,_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => this.runAutoGrow());
    }
    runAutoGrow() {
        const nativeInput = this.nativeInput;
    ...
    render() {
        ...
        const label = (0,_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
        if (label) {
            label.id = labelId;
        }
        return ((0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.H, { "aria-disabled": this.disabled ? 'true' : null, class: (0,_theme_5641d27f_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
                [mode]: true,
            }) }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "textarea-wrapper", ref: el => this.textareaWrapper = el }, (0,_index_92848855_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", { class: "native-textarea", "aria-labelledby": labelId, ref: el => this.nativeInput = el, autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, disabled: this.disabled, maxLength: this.maxlength, minLength: this.minlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown }, value))));
    }
