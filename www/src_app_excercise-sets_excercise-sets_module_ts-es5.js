  ...
  (self["webpackChunkmemory"] = self["webpackChunkmemory"] || []).push([["src_app_excercise-sets_excercise-sets_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ChoosingComponent": function ChoosingComponent() {
          return (
            /* binding */
            _ChoosingComponent
          );
      ...
      var _raw_loader_choosing_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./choosing.component.html */
      83484);
      /* harmony import */


      var _choosing_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./choosing.component.scss */
      45932);
      /* harmony import */
      ...
      var src_app_shared_eventemitter_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _ChoosingComponent = /*#__PURE__*/function () {
        function ChoosingComponent(gameService, eventEmitter) {
          _classCallCheck(this, ChoosingComponent);
        ...
        _createClass(ChoosingComponent, [{
          key: "ngOnInit",
          ...
          value: function onSubmit() {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                var _iterator3 = _createForOfIteratorHelper(inputtedanswers),
                    _step3;
            ...
            var score = this.gameService.getScore(this.answers.length, wrongs);
      ...
      _ChoosingComponent.ctorParameters = function () {
        return [{
      ...
      _ChoosingComponent.propDecorators = {
        choices: [{
      ...
      _ChoosingComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ExcerciseSetsPageRoutingModule": function ExcerciseSetsPageRoutingModule() {
          return (
            /* binding */
            _ExcerciseSetsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _excercise_sets_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./excercise-sets.page */
      10092);
      ...
      var _ExcerciseSetsPageRoutingModule = function ExcerciseSetsPageRoutingModule() {
        _classCallCheck(this, ExcerciseSetsPageRoutingModule);
      };

      _ExcerciseSetsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ExcerciseSetsPageModule": function ExcerciseSetsPageModule() {
          return (
            /* binding */
            _ExcerciseSetsPageModule
          );
        }
        /* harmony export */
      ...
      var _excercise_sets_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./excercise-sets-routing.module */
      62928);
      /* harmony import */


      var _excercise_sets_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./excercise-sets.page */
      10092);
      /* harmony import */


      var _games_list_games_list_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../games-list/games-list.module */
      67985);
      /* harmony import */
      ...
      var _choosing_choosing_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./choosing/choosing.component */
      95778);

      var _ExcerciseSetsPageModule = function ExcerciseSetsPageModule() {
        _classCallCheck(this, ExcerciseSetsPageModule);
      };

      _ExcerciseSetsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_9__.IonicModule, _excercise_sets_routing_module__WEBPACK_IMPORTED_MODULE_0__.ExcerciseSetsPageRoutingModule, _games_list_games_list_module__WEBPACK_IMPORTED_MODULE_2__.GamesListModule, _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__.SharedModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ExcerciseSetsPage": function ExcerciseSetsPage() {
          return (
            /* binding */
            _ExcerciseSetsPage
          );
      ...
      var _raw_loader_excercise_sets_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./excercise-sets.page.html */
      65499);
      /* harmony import */


      var _excercise_sets_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./excercise-sets.page.scss */
      44225);
      /* harmony import */
      ...
      var _ExcerciseSetsPage = /*#__PURE__*/function () {
        function ExcerciseSetsPage(activatedroute, gameService, eventEmitter) {
          _classCallCheck(this, ExcerciseSetsPage);
        ...
        _createClass(ExcerciseSetsPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;
            ...
            this.memorizedSubscription = this.eventEmitter.memorizedItems.subscribe(function (value) {
              _this.choices = value.choices;
              _this.answers = value.correct;
            ...
            this.activatedroute.params.subscribe(function (value) {
              _this.set = _this.gameService.excerciseSetsDescription[_this.gameService.excerciseSets[value.number - 1].type - 1].gameIndexes;
              _this.levels = _this.gameService.excerciseSets[value.number - 1].level;
              console.log(_this.set);
              var currindex = _this.set[_this.currentIndex];
              var currnum;

              if (currindex.number) {
                currnum = currindex.number;
                _this.spclVar = currindex.spclVar;
              } else {
                currnum = currindex;
              }

              _this.hiddenArray[currnum] = false;
            ...
            this.subscription = this.eventEmitter.RoundFinished.subscribe(function (value) {
              if (value) {
                if (value.score) {
                  _this.aggregatescore = _this.aggregatescore + value.score;
                }

                var currnum = _this.set[_this.currentIndex];

                if (currnum.number) {
                  _this.hiddenArray[currnum.number] = true;
                } else {
                  _this.hiddenArray[currnum] = true;
                }

                _this.currentIndex++;
                currnum = _this.set[_this.currentIndex];

                if (_this.hiddenArray[currnum]) {
                  if (currnum.number) {
                    _this.hiddenArray[currnum.number] = false;
                  } else {
                    _this.hiddenArray[currnum] = false;
                  }
                } else {
                  _this.finalishidden = false;
                  console.log(_this.aggregatescore);
                }

                console.log(_this.choices, _this.currentIndex, _this.set[_this.currentIndex], _this.hiddenArray);
              }
            });
        ...
        return ExcerciseSetsPage;
      }();

      _ExcerciseSetsPage.ctorParameters = function () {
        return [{
      ...
      _ExcerciseSetsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "GamesListModule": function GamesListModule() {
          return (
            /* binding */
            _GamesListModule
          );
      ...
      var _card_span_card_span_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./card-span/card-span.module */
      84754);
      /* harmony import */


      var _digit_span_digit_span_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./digit-span/digit-span.module */
      64842);
      /* harmony import */


      var _trivia_trivia_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./trivia/trivia.module */
      33981);
      /* harmony import */


      var _sort_them_sort_them_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./sort-them/sort-them.module */
      55225);
      /* harmony import */


      var _stroop_game_stroop_game_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./stroop-game/stroop-game.module */
      47521);
      /* harmony import */


      var _traffic_light_traffic_light_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./traffic-light/traffic-light.module */
      94348);
      /* harmony import */


      var _word_pairs_word_pairs_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./word-pairs/word-pairs.module */
      37321);
      /* harmony import */


      var _word_to_images_word_to_images_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./word-to-images/word-to-images.module */
      3926);
      /* harmony import */


      var _wordfinder_wordfinder_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./wordfinder/wordfinder.module */
      48169);
      /* harmony import */


      var _matrix_reasoning_matrix_reasoning_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./matrix-reasoning/matrix-reasoning.module */
      264);

      var _GamesListModule = function GamesListModule() {
        _classCallCheck(this, GamesListModule);
      };

      _GamesListModule = (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.NgModule)({
        declarations: [],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_12__.CommonModule, _card_span_card_span_module__WEBPACK_IMPORTED_MODULE_0__.CardSpanPageModule, _digit_span_digit_span_module__WEBPACK_IMPORTED_MODULE_1__.DigitSpanPageModule, _trivia_trivia_module__WEBPACK_IMPORTED_MODULE_2__.TriviaPageModule, _sort_them_sort_them_module__WEBPACK_IMPORTED_MODULE_3__.SortThemPageModule, _stroop_game_stroop_game_module__WEBPACK_IMPORTED_MODULE_4__.StroopGamePageModule, _traffic_light_traffic_light_module__WEBPACK_IMPORTED_MODULE_5__.TrafficLightPageModule, _word_pairs_word_pairs_module__WEBPACK_IMPORTED_MODULE_6__.WordPairsPageModule, _word_to_images_word_to_images_module__WEBPACK_IMPORTED_MODULE_7__.WordToImagesPageModule, _wordfinder_wordfinder_module__WEBPACK_IMPORTED_MODULE_8__.WordfinderPageModule, _matrix_reasoning_matrix_reasoning_module__WEBPACK_IMPORTED_MODULE_9__.MatrixReasoningPageModule],
        exports: [_card_span_card_span_module__WEBPACK_IMPORTED_MODULE_0__.CardSpanPageModule, _digit_span_digit_span_module__WEBPACK_IMPORTED_MODULE_1__.DigitSpanPageModule, _trivia_trivia_module__WEBPACK_IMPORTED_MODULE_2__.TriviaPageModule, _sort_them_sort_them_module__WEBPACK_IMPORTED_MODULE_3__.SortThemPageModule, _stroop_game_stroop_game_module__WEBPACK_IMPORTED_MODULE_4__.StroopGamePageModule, _traffic_light_traffic_light_module__WEBPACK_IMPORTED_MODULE_5__.TrafficLightPageModule, _word_pairs_word_pairs_module__WEBPACK_IMPORTED_MODULE_6__.WordPairsPageModule, _word_to_images_word_to_images_module__WEBPACK_IMPORTED_MODULE_7__.WordToImagesPageModule, _wordfinder_wordfinder_module__WEBPACK_IMPORTED_MODULE_8__.WordfinderPageModule, _matrix_reasoning_matrix_reasoning_module__WEBPACK_IMPORTED_MODULE_9__.MatrixReasoningPageModule]
      })], _GamesListModule);
      /***/
    },
